...
(function ($) {
  ...
  */
    ...
    var $indicators = $('<ol>').attr('class', 'progress-circles');
  ...
  */
    $.each(questions, function (question_index, question) {
      ...
      var $img_div;
      if (question.image) {
        $img_div = $('<div>').attr('class', 'question-image').appendTo($item);
        $('<img>')
      ...
      var $answers = $('<div>').attr('class', 'quiz-answers').appendTo($item);
          ...
          opts = $.extend(opts, {
            ...
            text:
              ...
              (question.correct.image
                ? '<br><br><img class="correct-image" src="' +
                  question.correct.image +
                  '"><br><br>'
                : '') +
        ...
        ans_btn.on('click', function () {
          function next() {
            ...
            if (last_question) {
              ...
              $indicators.find('li').removeClass('dark').eq(0).addClass('dark');
            } else {
              // indicate the question number
              $indicators
                .find('li')
    ...
    var $social = $('<div>')
      ...
      .html(
        '<div id = "social-text">Nice right? Share this with your friends and find out how they do!</div>'
      )
      .appendTo($results_slide);
    ...
    $(window).on('resize', function () {
      $quiz.find('.item').attr('height', $quiz.height() + 'px');
    });
  }
  ...
  function resultsText(state) {
    ...
    switch (true) {
      case ratio === 1:
        text =
          'Amazing! You have a suspiciously firm grasp of lupsup KTVs and terribly named condos. I see bright things in your future.';
        break;
      case ratio >= 0.90:
        text = 'Close but no corona.';
        break;
      case ratio >= 0.60:
        text =
          'Neither here nor there, the Multi-Ministry Taskforce would be proud!';
        break;
      case ratio === 0.50:
        text = 'Just a pass. Tiger parents everywhere just shed a tear.';
        break;
      case ratio < 0.50 && ratio !== 0:
        text = 'Don\u2019t worry, every school is a good school!';
        break;
      case ratio === 0:
        text =
          'Amazing! You got none right. That almost takes more effort than doing well!';
        break;
    }
    return text;
  }
  ...
  function tweet(state, opts) {
    var body =
      ...
      ' out of ' +
      state.total +
      " on 'KTV or Condo?'. Can you tell Singapore\u2019s KTVs from our Condos just by the name? Try it here: " +
      opts.url;

    return 'http://twitter.com/intent/tweet?text=' + encodeURIComponent(body);
  }
